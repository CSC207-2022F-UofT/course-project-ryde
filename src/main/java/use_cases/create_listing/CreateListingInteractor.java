    ...
    public void create(CreateListingRequestModel requestModel) {
        ...
        if (brand.equals("") || name.equals("") || color.equals("") || description.equals("")) {
            ...
            if(listing.validType()) {
                ...
                CreateListingDsRequestModel dsRequestModel = new CreateListingDsRequestModel(listing.getUniqueId(),
                        listing.getBrand(), listing.getName(), listing.getColor(), Integer.toString(listing.getYear()),
                        String.valueOf(listing.getNumSeats()), String.valueOf(listing.getPrice()),
                        listing.getUserEmail(), listing.getPhoneNumber(), listing.getDescription(),
                        listing.getType(), listing.getDateCreated());
