...
//        setting up the csv file.
    ...
    void displayListingsSuccess() {
        ...
        assertEquals("manav@gmail.com", model1.getUserEmail());
        assertEquals("manav@gmail.com", model2.getUserEmail());
        assertEquals("manav@gmail.com", model3.getUserEmail());
    }
    ...
    void testDeleteListingSuccess() {
        ...
        assertEquals("Successfully deleted Toyota Corolla listing!", status);
